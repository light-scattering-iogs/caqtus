...
from PySide6.QtWidgets import QAbstractItemView, QMenu, QTreeView, QWidget
...
class StepsIterationEditor(QWidget, SequenceIterationEditor[StepsConfiguration]):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self._steps_tree_editor = StepsTreeEditor(self)
        layout.addWidget(self._steps_tree_editor)
        ...
        self.add_tunable_parameter_action = self.toolbar.addAction(
            get_icon("mdi6.tune-variant", self.palette().buttonText().color()),
    ...
    def undo_stack(self) -> QUndoStack:
        ...
        return self._steps_tree_editor._model.undo_stack
    ...
    def _setup_add_button(self):
        ...
        self.add_shot_action.triggered.connect(
            functools.partial(
                self._steps_tree_editor._model.insert_steps,
                [create_shot_step()],
                self._steps_tree_editor._model.rowCount(),
                QModelIndex(),
            )
        )
    ...
    def get_iteration(self) -> StepsConfiguration:
        ...
        return self._steps_tree_editor._model.get_steps()
    ...
    def set_iteration(self, iteration: StepsConfiguration):
        ...
        self._steps_tree_editor._model.set_steps(iteration)
        self._steps_tree_editor.expandAll()
    ...
    def set_available_parameter_names(self, parameter_names: Set[DottedVariableName]):
        ...
        user tries to edit the name of a variable or a loop.
        """

        self._steps_tree_editor._delegate.set_available_names(parameter_names)

    def set_read_only(self, read_only: bool) -> None:
        self._steps_tree_editor.set_read_only(read_only)
        self.paste_from_clipboard_action.setEnabled(not read_only)
        self.add_button.setEnabled(not read_only)

    def is_read_only(self) -> bool:
        return self._steps_tree_editor.is_read_only()
...
class StepsTreeEditor(QTreeView):
