...
class Ui_SingleShotWidget(object):
    def setupUi(self, SingleShotWidget):
        ...
        self.menuAdd.addAction(self.actionAtoms)
        self.menuAdd.addAction(self.actionParameters)
        self.menuWorkspace.addAction(self.actionSave)
    ...
    def retranslateUi(self, SingleShotWidget):
        ...
        self.menuAdd.setTitle(_translate("SingleShotWidget", "Add viewer"))
