...
variables = VariableNamespace(
    {
        ...
        "red_mot": {
            "x_current": Quantity(0.247, "ampere"),
            "y_current": Quantity(0.19, "ampere"),
            "z_current": Quantity(0.027, "ampere"),
            "frequency": Quantity(-1, "megahertz"),
            "power": Quantity(-36, "decibel"),
            "current": Quantity(1, "ampere"),
        },
        "push_power": Quantity(0.5, "milliwatt"),
        "hold_time": Quantity(80, "millisecond"),
        ...
        "imaging": {
            ...
            "frequency": Quantity(-17.9, "megahertz"),
        ...
        "rearrange": {
            "tweezer_power": Quantity(0.6, "dimensionless"),
            "time": Quantity(400, "microsecond"),
        },
        "rep": Quantity(17, "dimensionless"),
    }
)
