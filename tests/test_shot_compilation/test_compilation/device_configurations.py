from caqtus_devices.ni6738_analog_card.configuration import NI6738SequencerConfiguration
from caqtus_devices.orca_quest.configuration import OrcaQuestCameraConfiguration
from caqtus_devices.spincore_pulse_blaster.configuration import (
    SpincoreSequencerConfiguration,
)
from caqtus_devices.swabian_pulse_streamer.configuration import (
    ...
    "Spincore": SpincoreSequencerConfiguration(
        ...
        channels=(
            ...
            DigitalChannelConfiguration(
                ...
                output=DeviceTrigger(device_name="Orca Quest", default=None),
            ),
            DigitalChannelConfiguration(
