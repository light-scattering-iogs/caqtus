...
class Ui_ElliptecELL14RotationStageConfigEditor(object):
    def setupUi(self, ElliptecELL14RotationStageConfigEditor):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.serialPortLabel)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self._serial_port_widget)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self._device_id_spinbox)
        self.angleLabel = QtWidgets.QLabel(parent=ElliptecELL14RotationStageConfigEditor)
        self.angleLabel.setObjectName("angleLabel")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.angleLabel)
        self._angle_line_edit = QtWidgets.QLineEdit(parent=ElliptecELL14RotationStageConfigEditor)
        self._angle_line_edit.setToolTip("")
        self._angle_line_edit.setObjectName("_angle_line_edit")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self._angle_line_edit)
